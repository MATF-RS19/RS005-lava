...
class Animation{
public:
	Animation(Man &m, std::vector<Stone> &s,Bonus &b, int jump_ongoing=0, double jumped=0.0, int anim_stone=0, double stone=0.0, int num = -1,  int pom_anim=0,int score_num=0)
